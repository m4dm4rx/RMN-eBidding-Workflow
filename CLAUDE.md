...
## Data entry workflow
User pastes row(s) from Excel spreadsheet → Claude adds to SEED_BIDS in HTML → git push → Netlify auto-deploys.
...
- `status`: "รอผลพิจารณา / เป็นผู้เสนอราคาต่ำสุด" (default)
