...
- **09-13 · 🤝 GPT/Codex quota restored — RMN SAVE QUOTA POLICY (มติ King Marx ผ่าน Raven จาก Lord COMMANDER of GPT)** — GPT-side capacity กลับมา 100% (5hr+weekly) ออกจาก quota-hold · กติกาใหม่: **Chat** = คิด/ตัดสินใจ/Raven/architecture/review/Execution Cards · **Work/Codex** = execution จริงเท่านั้น (browser/computer use/repo/deploy/live verify) · งานเดิม resume ไม่ restart · human-action blocker หยุด execution ทันที · ห้าม DA/Chat duplicate execution ที่ Knight ถืออยู่
...
## ⚙️ Core Rules
- **ปิดงาน/Execution Card เสร็จ → ออก Raven report เองทันทีอัตโนมัติ ห้ามรอ user พิมพ์ "raven report"** (feedback 09-13: รู้สึกต้องถามตลอด)
