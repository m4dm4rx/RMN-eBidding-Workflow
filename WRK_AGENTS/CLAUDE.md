...
| ~~UI/UX EDITOR~~ | 🚫 **DISABLED 2026-09-26** (มติ King Marx) — งานแก้ tracker/เว็บ → เปิดงานใน Linear `P-RMN-4 WEBAPP DATABASE` (ทำร่วม Codex) · ไฟล์ `KB_UIUX.md`/`WRK_UIUX.md` เก็บไว้ ห้ามลบ · Data Separation Rules ด้านล่างยังบังคับทุกคนที่แก้ tracker | — |
...
- 💰 **Finance Capture = ระบบแยกจาก e-Bidding โดยสิ้นเชิง** — ห้ามอ้างอิง/ใส่ข้อมูล Finance Capture ใน repo public / Pages / tracker ทุกกรณี (ประวัติเต็ม → `CLAUDE_ARCHIVE_2569H2.md`)
...
## 📦 Archive
- ประกาศ 09-07…09-13 (naming / Raven / Finance Capture) + Session State DA 09-13 ย้ายไป `WRK_AGENTS/CLAUDE_ARCHIVE_2569H2.md` เมื่อ 2026-09-26 — **ไม่ต้องอ่านตอนเปิด session**
