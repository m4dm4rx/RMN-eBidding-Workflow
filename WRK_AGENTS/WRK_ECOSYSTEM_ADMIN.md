...
- 📧 **`gmail-bid-auto-update` ถูก disable แล้ว และไม่ต้องสร้างใหม่** (ยืนยัน King Marx 09-08) — ตั้งแต่สร้างมาไม่เคยมีเมลเข้าเลย · DA ตรวจกล่องจริงย้อน 60 วัน เจอเมลจาก `gprocurement.go.th` **1 ฉบับ** และเป็น *ใบรับเรื่องแบบแจ้ง* ไม่ใช่ประกาศประมูล → **e-GP ไม่ส่งประกาศเชิญชวนทางอีเมล** ⛔ **ห้ามสร้าง watcher ทางอีเมลอีก มันไม่มีวันทำงาน** · ช่องทางรู้ว่ามีประมูล = เปิดพอร์ทัล e-GP เองเท่านั้น
