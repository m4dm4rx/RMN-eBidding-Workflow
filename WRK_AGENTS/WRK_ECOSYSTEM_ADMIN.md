...
- 📧 **`gmail-bid-auto-update` ถูก disable แล้ว — สาเหตุที่แท้จริงยังไม่ปิด** (แก้บันทึกที่ DA เขียนผิดเมื่อ 09-08 · **ผมสรุปเร็วเกินไปว่า "e-GP ไม่ส่งเมล" ซึ่งไม่ใช่**) · ของจริง: King Marx **ตั้ง forward ในระบบ e-GP ให้ส่งเมลแจ้งผลผู้ชนะเข้ากล่องนี้อัตโนมัติ แต่ไม่เคยมาสักฉบับ** · หลักฐาน DA ตรวจกล่องจริง (รวม spam+trash ไม่จำกัดวัน): มีเมลจาก `gprocurement.go.th` **1 ฉบับเดียวตลอดกาล** — `เลขที่แบบแจ้ง 69081989 รับเรื่องเรียบร้อยแล้ว` (19/08/2569) เข้า **INBOX ไม่ใช่ spam** ถึง `marx.s.barapromme@gmail.com` → **เส้นทางส่งใช้ได้จริง** แต่ **เมลแจ้งผลผู้ชนะไม่เคยถูกส่งออกมาเลย** = ปัญหาอยู่ฝั่ง e-GP ไม่ใช่ฝั่งกล่องเมล
